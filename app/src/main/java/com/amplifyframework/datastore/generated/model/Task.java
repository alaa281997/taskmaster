...
public final class Task implements Model {
  ...
  private Task(String id, String title, String body, String status, String fileName, Team team) {
    this.id = id;
    this.title = title;
    this.body = body;
    this.status = status;
  ...
  public static class Builder implements TitleStep, BodyStep, StatusStep, TeamStep, BuildStep {
    private String id;
    ...
    @Override
     public TeamStep status(String status) {
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String body, String status, String fileName, Team team) {
      super.id(id);
      super.title(title)
        .body(body)
        .status(status)
